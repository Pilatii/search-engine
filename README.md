...
Este projeto implementa um mecanismo de busca textual utilizando Node.js e PostgreSQL, com foco em indexação e performance. A ideia principal é criar um Search Engine sem ultiliar ORMs ou frameworks.
...
Cada termo existe apenas uma vez no banco, enquanto a relação entre documento e termo armazena a frequência daquele termo no documento, perminitndo:
...
5. Todo o processo roda dentro de uma transação, evitano:
